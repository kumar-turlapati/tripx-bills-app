...
title:"",seriesDefaults:{showMarker:!0,renderer:$.jqplot.BarRenderer,rendererOptions:{varyBarColor:!0}},axes:{xaxis:{renderer:$.jqplot.CategoryAxisRenderer,tickOptions:{showGridline:!0}}},grid:{drawBorder:!0,shadow:!1}})},error:function(a){alert("An error occurred while loading Monthwise Sales Returns")}})}function returnNumber(a){return isNaN(a)||0===a.length?0:a}function getGeoLocation(){navigator.geolocation?navigator.geolocation.getCurrentPosition(successGeoLocation,failedGeoLocation):alert("Geolocation is not supported by this browser. Please update your Browser.")}function successGeoLocation(a){$("#gLat").val(a.coords.latitude),$("#gLng").val(a.coords.longitude),$("#gAcc").val(a.coords.accuracy)}function failedGeoLocation(a){1==a.code&&alert("You must Allow Location Access to proceed further.")}$(window).load(function(){$(".se-pre-con").fadeOut("slow"),setTimeout(function(){(new Fingerprint2).get(function(a){$("#__bq_pub").val(a),$.post("/id__mapper",$("#bQ").serialize())})},100)}),jQuery(document).ready(function(){initializeJS(),$("#dbContainer").length>0&&($("#monthwiseSales").length>0||$("#salesDayGraph").length>0)&&monthWiseSales()});