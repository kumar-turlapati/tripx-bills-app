      ...
      <li class="sub-menu">
        ...
        <ul class="sub">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/inward-entry/list"><i class="fa fa-angle-right"></i> Purchases</a></li>
              <li><a href="/grn/list"><i class="fa fa-angle-right"></i> GRNs</a></li>
              <li><a href="/purchase-return/register"><i class="fa fa-angle-right"></i> Purchase Returns</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:void(0)">
            ...
            <ul class="sub">
              <li><a href="/fin/payment-vouchers"><i class="fa fa-angle-right"></i> Payments</a></li> 
              <li><a href="/fin/receipt-vouchers"><i class="fa fa-angle-right"></i> Receipts</a></li> 
              <li><a href="/fin/credit-notes"><i class="fa fa-angle-right"></i> Credit Notes</a></li>
              <li><a href="/fin/petty-cash-book"><i class="fa fa-angle-right"></i> Petty Cash Book</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:void(0)">
            ...
            <ul class="sub">
              ...
              <li><a href="/barcodes/list"><i class="fa fa-angle-right"></i> Barcodes</a></li>
