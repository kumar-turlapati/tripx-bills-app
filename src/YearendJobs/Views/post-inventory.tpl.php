...
<div class="row">
  <div class="col-lg-12"> 
    <section class="panel">
      <h2 class="hdg-reports text-left"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;This option will transfer all the Inventory Closing Balances to a new financial year.</h2>
