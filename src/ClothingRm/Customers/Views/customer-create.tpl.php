<?php
  ...
  if(isset($submitted_data['dateOfBirth']) && $submitted_data['dateOfBirth'] !== '0000-00-00') {
    $dob = date("d-m-Y", strtotime($submitted_data['dateOfBirth']));
  } else {
    $dob = '';
  }
  if(isset($submitted_data['dateOfMarriage']) && $submitted_data['dateOfMarriage'] !== '0000-00-00') {
