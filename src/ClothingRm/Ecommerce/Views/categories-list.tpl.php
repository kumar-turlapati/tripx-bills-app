      ...
      <div class="panelBody">
        ...
        <div class="global-links actionButtons clearfix">
          <div class="pull-right text-right">
            <a href="/ecom/category/create" class="btn btn-default">
            ...
            <table class="table table-striped table-hover">
              <thead>
                <tr class="font12">
                  ...
                  <th width="10%" class="text-center">Category name</th>
                  <th width="10%" class="text-center">Subcategories</th>
                  <th width="25%" class="text-center">Category short desc.</th>
                  <th width="25%" class="text-center">Category long desc.</th>
              ...
              <tbody>
                <?php 
                  ...
                  foreach($categories as $category_details):
                    ...
                    $category_url = '/ecom/category/update/'.$category_details['categoryID'];
                    $subcats_count = $category_details['subCategoriesCount'];
                ?>
                  <tr class="text-uppercase text-right font11">
                    ...
                    <td class="text-center valign-middle"><?php echo $subcats_count > 0 ? $subcats_count : '' ?></td>
                    ...
                    <td class="text-right valign-middle">
                      <div class="btn-actions-group">
                        <a class="btn btn-info" href="<?php echo $category_url ?>" title="Edit category">
                          <i class="fa fa-pencil" aria-hidden="true"></i>
                        </a>
                        <a class="btn btn-success" href="/ecom/subcategories/<?php echo $category_details['categoryID'] ?>" title="Sub categories">
                          <i class="fa fa-copy" aria-hidden="true"></i>
                        </a>
                        <a class="btn btn-danger delEcomSubcat" href="/ecom/category/delete/<?php echo $category_details['categoryID'] ?>" title="Delete Category">
