      ...
      <div class="panel-body" align="center">
        ...
        <?php if(is_null($refreshed)) : ?>
          <form class="form-validate form-horizontal" method="POST" autocomplete="off" id="refreshCbForm">
            ...
            <?php /*<h3 id="infoText">Are you sure. You want to refresh the closing balances?</h3> */ ?>
        ...
        <?php else : ?>
          ...
          <div class="text-center">
            ...
            <button class="btn btn-warning" onclick="window.location.href='/inventory/refresh-cb'">
