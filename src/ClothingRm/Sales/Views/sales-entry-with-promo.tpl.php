            ...
            <table class="table table-striped table-hover font12">
              <thead>
                <tr>
                  ...
                  <th width="10%" class="text-center">Promo code</th>                  
                ...
                ?>
                  <tr>
                    ...
                    <td style="vertical-align:middle;">
                      <div class="select-wrap">
                        <select 
                          class="form-control iPromoCode"
                          id="iPromoCode_<?php echo $i-1 ?>" 
                          name="itemDetails[iPromoCode][]"
                          style="font-size:12px;"
                        >
                          <?php 
                            foreach($offers as $offer_code => $offer_name): 
                    ...
                    <td style="vertical-align:middle;" align="right">
                      <input
                        ...
                        style="text-align:right;font-weight:bold;font-size:14px;border:1px dashed;"
                      >
                    </td>
