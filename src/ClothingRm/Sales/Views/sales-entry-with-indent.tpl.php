<?php
  ...
  $ow_items_class = $tot_products > 0 && $is_submitted ? '' : 'style="display:none;"';
  $form_submit_url = '/sales/entry-with-indent/'.$ic;
    ...
    <section class="panelBox">
      <div class="panelBody">
        ...
        <form id="outwardEntryForm" method="POST" action="<?php echo $form_submit_url ?>">
          ...
          <div class="panel" style="margin-bottom:15px;<?php echo $tot_products > 0  && $customer_type === 'b2b' && $is_submitted ? '' : 'display:none;' ?>" id="siOtherInfoWindow">
          ...
          <div class="panel" style="margin-bottom:10px;<?php echo $tot_products > 0 && $is_submitted ? '' : 'display:none;' ?>" id="paymentMethodWindow">
            <div class="panel-body" style="border: 1px dotted;">
              <div class="form-group">
          ...
          <div class="panel" style="margin-bottom:10px;<?php echo $tot_products > 0 && $is_submitted ? '' : 'display:none;' ?>" id="customerWindow">
            <div class="panel-body" style="border: 1px dotted;">
              <div class="form-group">
                <div class="col-sm-12 col-md-3 col-lg-3">
          ...
          <div class="panel" style="margin-bottom:15px;<?php echo $tot_products > 0 && (int)$payment_method === 2  && $is_submitted ? '' : 'display:none;' ?>" id="splitPaymentWindow">
            <div class="panel-body" style="border: 1px dotted;">
              <div class="form-group">
                <div class="col-sm-12 col-md-2 col-lg-2">
          ...
          <div class="panel" style="margin-bottom:10px;<?php echo $tot_products > 0 && $is_submitted ? '' : 'display:none;' ?>" id="remarksWindow">
          ...
          <div class="text-center" id="saveWindow" style="<?php echo $tot_products > 0 && $is_submitted ? '' : 'display:none;' ?>">
            <?php 
              if($promo_key !== '') {
          ...
          <?php foreach($form_data['itemDetails']['itemName'] as $item_name): ?>
            <input type="hidden" name="indentItems" id="indentItem_<?php echo $item_name ?>" value="<?php echo $item_name ?>" />
          <?php endforeach; ?>
        </form>
      </div>
    </section>
