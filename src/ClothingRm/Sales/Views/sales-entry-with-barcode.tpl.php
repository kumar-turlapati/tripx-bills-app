  ...
  <div class="col-lg-12"> 
    <section class="panelBox">
      <div class="panelBody">
        ...
        <form id="outwardEntryForm" method="POST" action="<?php echo $form_submit_url ?>" autocomplete="off">
          <div class="table-responsive">
            <table class="table table-hover font12" style="border-top:none;border-left:none;border-right:none;border-bottom:1px solid;margin-bottom: 0px;">
              <thead>
                <tr>
                  <td style="vertical-align:middle;font-size:12px;font-weight:bold;border-right:none;border-left:none;border-top:none;text-align:right;width:10%;border-bottom: none;">Customer name</td>
                  <td style="vertical-align:middle;border-right:none;border-left:none;border-top:none;width:10%;border-bottom: none;">
                    <input 
                      type="text" 
                      ...
                      style="font-size:12px;font-weight:bold;border:1px dotted #225992;padding-left:5px;height: 23px;"
                    />
                  </td>
                  <td style="vertical-align:middle;font-size:12px;font-weight:bold;border-right:none;border-left:none;border-top:none;text-align:right;width:10%;border-bottom: none;">Customer mobile</td>
                  <td style="vertical-align:middle;border-right:none;border-left:none;border-top:none;width:15%;text-align:left;border-bottom: none;">
                    <input 
                      type="text" 
                  ...
                  <td style="vertical-align:middle;border-right:none;border-left:none;border-top:none;width:15%;text-align:left;border-bottom: none;">
                    <button class="btn btn-link" id="scanWindowMainButton">
                      <i class="fa fa-barcode"></i> Start Scan
                    </button>                    
                  </td>
                </tr>
                <tr id="scanWindowTr" style="display:none;">
          ...
          <div id="scanWindowMainDiv" style="display: none;">
            <div class="table-responsive">
