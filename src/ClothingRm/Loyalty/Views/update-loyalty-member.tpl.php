...
<div class="row">
  <div class="col-lg-12"> 
    <section class="panel">
      <h2 class="hdg-reports text-center">Update Loyalty Member</h2>
      <div class="panel-body">
        ...
        <form class="form-validate form-horizontal" method="POST">
          ...
          <input type="hidden" name="memberCode" id="memberCode" value="<?php echo $member_code ?>" />
        </form>
      </div>
    </section>
  </div>
