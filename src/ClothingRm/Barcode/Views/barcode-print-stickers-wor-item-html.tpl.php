  ...
  <body>
    ...
    <?php 
      ...
      foreach($printable_array as $print_qty_details):
        ...
        $print_qty = $print_qty_details[0];
        $print_item_name = strtoupper(substr($print_qty_details[1],0,30));
        $print_item_name1 = strtoupper(substr($print_qty_details[1],23,22));        
    ...
    ?>
      <div>
        ...
        <div class="rate"><?php /*Qty.: <?php echo $packed_qty ?> */?></div>
