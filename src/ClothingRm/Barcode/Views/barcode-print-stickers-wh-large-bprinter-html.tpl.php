      ...
      <div class="labelSheet">
        <div>
          <div class="overflowText">
            ...
            <div style="text-align: center;padding-bottom: 0px;"><img src="<?php echo $barcode_image ?>" width="190" height="30" alt="NoImage" class="bimg" /></div>
            ...
            <div class="mfgDate" style="font-weight: bold; font-size: 14px;"><?php echo $print_item_name ?></div>
          </div>
        </div>
      </div>
