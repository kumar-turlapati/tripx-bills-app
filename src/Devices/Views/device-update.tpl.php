<?php
  ...
  } elseif(isset($submitted_data['uuid'])) {
    $uid = $submitted_data['uuid'];
  } else {
    $uid = '';
  }
  ...
  if(isset($submitted_data['deviceCode'])) {
    $device_code = $submitted_data['deviceCode'];
  } else {
    $device_code = '';
  }  
?>
    ...
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <form class="form-validate form-horizontal" method="POST" autocomplete="Off">
          ...
          <input type="hidden" name="deviceCode" id="deviceCode" value="<?php echo $device_code ?>" />
